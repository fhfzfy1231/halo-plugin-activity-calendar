...
public class ActivityCalendarEndpoint implements CustomEndpoint {
    ...
    private Mono<ServerResponse> calendar(ServerRequest request) {
        ...
        return dataService.calendar(year)
    ...
    private Mono<ServerResponse> debug(ServerRequest request) {
        ...
        report.put("pluginVersion", ActivityCalendarDataService.PLUGIN_VERSION);
        report.put("apiVersion", ActivityCalendarDataService.API_VERSION);
        report.put("buildSignature", ActivityCalendarDataService.BUILD_SIGNATURE);
    ...
    public GroupVersion groupVersion() {
        return GroupVersion.parseAPIVersion("api.activity.foxbridge.team/v1alpha2");
    }
}
